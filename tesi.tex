...
\begin{remark}
    ...
    by definition of profinite completion $\omega$ has dense image. Moreover, note that for $n>0$ there is an induced map
	\begin{equation}\label{eq:RecIso}
		\omega_n:\K^\times / \K^{\times n} \to \Gamma^{\text{ab}}/n \simeq \H{1}{\K}{\Zn}^*,
	\end{equation}
	given by the isomorphism \eqref{eq:CupIso} of local duality. Above, we used the fact that \[\H{1}{\K}{\Zn}=
