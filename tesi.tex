...
We now prove an important result about the cohomology of induced modules, which will allow us to prove statements about group cohomology by a technique known as \textit{dimension
    shifting} (as in Proposition \ref{prop:ConjId} below)
...
\begin{definition}
    ...
    \[
        f^*: \H{i}{G}{\varphi^*A}\to\H{i}{G^{\prime} }{B},
    \]
    and by precomposing with $f_i^*$ we get a homomorphism
    \[
...
\begin{definition}\
    \begin{itemize}
        ...
        \item Let $A$ be a $G$-module, and $N$ a normal subgroup of $G$. Then, the quotient $G/N$ acts naturally on $A^N$, and the inclusion of $A^H$ in $A$ is compatible with the projection $\pi: G\to G/N$. This induces the \textbf{inflation} map
              \[
        ...
        \item Functoriality is useful even when there is no "change of group": let $A$ be a $G$-module, and fix an element $t$ of $G$.
