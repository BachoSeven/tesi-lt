...
\begin{remark}
	...
	\[
		...
		\begin{tikzcd}
			\H{1}{L}{\mu_n}\ar[dd, "\Cor"]\arrow[r,symbol=\times] &[-2em] \H{1}{L}{\mu_n} \ar[r, "\cup"]&[2em] \H{2}{L}{\mu_n} \ar[dd, "\Cor"]\ar[rd, sloped, "\sim"]&\\
			&&& \Zn \\
			\H{1}{\K}{\Zn} \arrow[r,symbol=\times] & \H{1}{\K}{\Zn}  \ar[swap, uu, "\Res"] \ar[r, "\cup"]& \H{2}{\K}{\mu_n} \ar[ru, sloped, "\sim"]&
		\end{tikzcd}
	\]
...
\begin{proof}
	...
	For uniqueness, given $L,M$ with $N_{L/\K}(L^\times)=N_{M/\K}(M^\times)$, we have a commutative diagram
\end{proof}
